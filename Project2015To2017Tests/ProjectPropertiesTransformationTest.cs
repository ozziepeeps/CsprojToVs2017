...
<Project DefaultTargets=""Build"" xmlns=""http://schemas.microsoft.com/developer/msbuild/2003"" ToolsVersion=""4.0"">
  ...
  <PropertyGroup>
    ...
    <RuntimeIdentifier>win7-x86</RuntimeIdentifier>
        ...
        [TestMethod]
        public async Task CoStarTransformationsAsync()
        {
            var xml = @"
<Project DefaultTargets=""Build"" xmlns=""http://schemas.microsoft.com/developer/msbuild/2003"" ToolsVersion=""4.0"">
  <Import Project=""$(MSBuildExtensionsPath)\$(MSBuildToolsVersion)\Microsoft.Common.props"" Condition=""Exists('$(MSBuildExtensionsPath)\$(MSBuildToolsVersion)\Microsoft.Common.props')"" />
  ...
  <PropertyGroup Condition="" '$(Configuration)|$(Platform)' == 'Release|AnyCPU' "">
    ...
    <CodeContractsAnalysisWarningLevel>0</CodeContractsAnalysisWarningLevel>
            ...
            Assert.AreEqual(0, project.ConditionalPropertyGroups.Descendants().Count(e => e.Name.LocalName.Contains("OutputPath")));
            Assert.AreEqual(0, project.ConditionalPropertyGroups.Descendants().Count(e => e.Name.LocalName.Contains("Optimize")));
        }
